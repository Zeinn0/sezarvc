...
from Zara.helpers import _zedutils, fileinfo
from Zara.helpers.functions import get_ytthumb, yt_search
    ...
    async def join_vc(self, chat, join_as=None):
        ...
        try:
            await self.app.join_group_call(
                chat_id=chat.id,
                stream=AudioPiped("sezarvc/resources/Silence01s.mp3"),
    ...
    async def leave_vc(self):
        ...
        for event in self.EVENTS:
            with contextlib.suppress(Exception):
                await event.delete()
        await _zedutils.runcmd("rm -rf temp")
        self.clear_vars()
        ...
        **kwargs,
        ...
        if reply:
            ...
            try:
                ...
                url = input
                img = (
                    "https://github.com/Tgzedub/sezarvcPlayer/raw/beta/resources/404.png"
                )
            ...
            if path.exists():
                ...
                if kwargs:
                    ...
                    img = "https://github.com/Tgzedub/sezarvcPlayer/raw/beta/resources/404.png"
        ...
        if not self.PLAYLIST:
            if self.PLAYING:
                await self.app.change_stream(
                    self.CHAT_ID,
                    AudioPiped("sezarvc/resources/Silence01s.mp3"),
                )
            self.PLAYING = False
